...
namespace ConcreteBridgeBeams.BeamTypes
{
    public class BoxBeam : IBeam
    {
        public BoxBeam(string type, double spacing, double dbeam, double lmin, double lmax)
        {
            Type = type;
            Spacing = spacing;
            Dbeam = dbeam;
